...
namespace InnerAPI.Models
{
    ...
    public class Branch : Institution
    {
        ...
        public Branch(uint id, string name, string email, string password, string cnpj, string domain) 
        {
            this.Id = id;
            this.Name = name;
            this.Email = email;
        ...
        public Branch(string name, string email, string password, string localidadeInstituicao, DateOnly dataCriacao)
        {
